...
@interface HZSliderButton : UIButton

@end

@implementation HZSliderButton
...
/** 滑块 */
@property (nonatomic, strong) HZSliderButton *sliderBtn;
...
- (HZSliderButton *)sliderBtn {
    if (!_sliderBtn) {
        _sliderBtn = [HZSliderButton buttonWithType:UIButtonTypeCustom];
